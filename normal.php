...
<body>
    <header>
        ...
        <div id="menu">
            ...
            <a href="register.php"><button>會員註冊</button></a>
            <button onclick="redirectToRegister()">購物車</button>
        </div>
    </header>
    <div id="banner">
        <p>歡迎光臨我們的二手商店！這裡是尋找珍寶與回憶的最佳去處(⁎⁍̴̛ᴗ⁍̴̛⁎)。我們致力於為顧客提供高品質、經濟實惠的二手商品，從日常用品到服飾、書籍，應有盡有。</p>
