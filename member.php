...
<body>
    <header>
        ...
        <div id="menu">
            ...
            <a href="help.php"><button>客服中心</button></a>
            <a href="car.php"><button>購物車</button></a>
            <a href="myorder.php"><button>我的訂單</button></a>
        </div>
    </header>
    <div id="banner">
        <p>歡迎光臨我們的二手商店！這裡是尋找珍寶與回憶的最佳去處(⁎⁍̴̛ᴗ⁍⁎)。我們致力於為顧客提供高品質、經濟實惠的二手商品，從日常用品到服飾、書籍，應有盡有。</p>
    ...
    <div id="featured">
        ...
        <div class="product">
            ...
            <p class="intro">商品介紹：<?php echo htmlspecialchars($row['intro']); ?></p>
